...
/**
 * Fetch detailed issues for a single page
 * Filters by assessmentId + pageName
 */
export const fetchDetailedIssues = async (assessmentId, pageName) => {
  ...
  // Filter only selected page issues
  return findings
