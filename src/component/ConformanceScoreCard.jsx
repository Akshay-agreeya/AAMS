...
export function ConformanceScoreCard() {
  ...
  useEffect(() => {
    const loadScore = async () => {
      try {
        const value = await fetchConformanceScore(assessmentId);
        setScore(value);
      } catch (err) {
        console.error("Failed to load conformance score", err);
      }
    };
  ...
  return (
    <div className="card">
      ...
      <div className="gauge-container">
        <div className="gauge-wrapper">
          <svg viewBox="0 0 200 100" className="gauge-svg">
            <path d="M 20 90 A 80 80 0 0 1 60 25" fill="none" stroke="#dc2626" strokeWidth="20" />
            <path d="M 60 25 A 80 80 0 0 1 100 10" fill="none" stroke="#ea580c" strokeWidth="20" />
            <path d="M 100 10 A 80 80 0 0 1 140 25" fill="none" stroke="#eab308" strokeWidth="20" />
            <path d="M 140 25 A 80 80 0 0 1 165 55" fill="none" stroke="#84cc16" strokeWidth="20" />
            <path d="M 165 55 A 80 80 0 0 1 180 90" fill="none" stroke="#22c55e" strokeWidth="20" />
