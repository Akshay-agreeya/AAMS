                                ...
                                <div className="userManagmentContainer">
                                    <div className="row">
                                        <div className="col-12 col-lg-2 profilePicture position-relative">
                                            ...
                                            <input type="file" id="fileInput" hidden accept="image/*" onChange={previewProfilePicture} />
                                        </div>
                                                ...
                                                <div className="formContainer">
                                                    <div className="row">
                                                        ...
                                                        <div className="col-lg-4 mb-3">
                                                            ...
                                                            <input type="text" className="form-control" name="contact_no" value={formData.contact_no} onChange={handleChange} />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="buttonBox">
                                                    <button type="button" className="btnCancel" onClick={() => navigate(-1)}>Cancel</button>
                                                    <button type="submit" className="btnAddUser"onClick={handleSubmit}>Save Details</button>
                                                </div>
                                            </Form>
                                        </div>
                                    </div>
